...
<head>
	<title>Mellow - We are Mellow. We build ideas.</title>
	...
	<meta property="og:description" content="A Mellow é especializada em arquitetura de software, desenvolvimento de aplicativos móveis para iOS e Android, web dev, design mobile e estratégia digital.." />
  ...
  <!--       <link rel="apple-touch-icon" sizes="57x57" href="favicon-57.png">
        ...
        <meta name="keywords" content="mellow, labmellow, mellow studio, estúdio, desenvolvimento, website, e-commerce, website responsivo, sistemas, aplicativos, aplicações web, arquitetura de software, web dev, aplicativos móveis, design web" />
        <meta name="description" content="A Mellow é especializada em arquitetura de software, desenvolvimento de aplicativos móveis para iOS e Android, web dev, design mobile e estratégia digital.." />
...
<!--         <link rel="shortcut icon" href="" type="image/x-icon" />
	...
	<script src="https://file.myfontastic.com/d2ck4JwSFFdUxyM8CHxb39/icons.js"></script>
</head>
<body>
	<div id="wrap">
		<header class="fixed">
		...
		<main>
			<section id="webdoor">
				<div class="flex">
					<div class="flex100">
						<div class="wrap">
							<h1>Olá, somos a Mellow.</h1>
							<p>A Mellow é especializada em arquitetura de software, desenvolvimento de aplicativos móveis para iOS e Android, web dev, design mobile e estratégia digital.</p>
							<a href="javascript:void(0)" rel="scroll" title="Conheça-nos" class="btn btn_default">Conheça-nos</a>
						</div>
					</div>
				</div>
			...
			<section id="o-que-fazemos">
				<div class="wrap flex">
					<h2 class="flex100"><span>O que fazemos</span></h2>
					<ul class="flex flex100">
						<li class="flex33">
							<i><svg class="mellow-iphone"><use xlink:href="#mellow-iphone"></use></svg></i>
							<h3>Apps</h3>
							<p>Desenvolvemos aplicativos para IOS e Android de acordo com a sua necessidade.</p>
						</li>
						<li class="flex33">
							<i><svg class="mellow-settings"><use xlink:href="#mellow-settings"></use></svg></i>
							<h3>Sistemas</h3>
							<p>Construímos Sistemas Web exclusivos, seguros e personalizados para sua empresa.</p>
						</li>
						<li class="flex33">
							<i><svg class="mellow-imac"><use xlink:href="#mellow-imac"></use></svg></i>
							<h3>Websites</h3>
							<p>Desenvolvemos Websites Responsivos que vão desde Sites Institucionais a E-commerce.</p>
						</li>
					</ul>
				</div>
			</section>
<!-- 			<section id="nossos-trabalhos">
			...
			<section id="contato">
				<div class="wrap flex">
					<h2 class="flex100"><span>Fale com a gente!</span></h2>
					<form class="flex100 form" action="<?php $PHP_SELF; ?>" method="POST" name="formulario" id="formulario">
						<div class="flex">
							...
							<span class="flex100">
								<textarea name="mensagem" placeholder="Mensagem" required="required"></textarea>
							</span>
	...
	<footer>
		<div class="wrap flex">
			...
			<div class="flex70 flex">
				<p>© <?php echo date("Y"); ?> Mellow _ Todos os direitos reservados.</p>
